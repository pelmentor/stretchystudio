...
| 0F.13–0F.34 — Test coverage backfill | ✅ shipped | various | Locked down 22 critical pure modules with ~860 tests: transforms, animationEngine, psdOrganizer, variantNormalizer, paramValuesStore, editorStore, frameConvert, animationStore, rigSpec, faceParallaxStore, rigWarpsStore, bodyWarpStore, xmlbuilder, mesh/sample, armatureOrganizer, idle/motionLib, rotationDeformers, warpDeformers, cmo3/pngHelpers, idle/builder, motion3json, io/exportAnimation. |
