...
**Status:** SHIPPED 2026-05-02 — see [`src/io/hitTest.js`](../../../src/io/hitTest.js), [`CanvasViewport.jsx`](../../../src/components/canvas/CanvasViewport.jsx) object-mode branch, `selection.selectAllToggle` operator + `KeyA` chord, [`../../WORKSPACES.md` § Click-to-select](../../WORKSPACES.md). Plan history retained below.
...
4. Update [../../WORKSPACES.md](../../WORKSPACES.md) with click-to-select section.
