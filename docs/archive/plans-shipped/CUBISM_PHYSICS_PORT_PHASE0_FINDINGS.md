...
**Plan doc:** [CUBISM_PHYSICS_PORT.md](../../live2d/CUBISM_PHYSICS_PORT.md)
...
4. **Driver fixtures (10):** rest, single-axis steps (X/Y/Z), single-axis sweeps, body angle sustained, breath cycle, combined head+body, step-input jump, extreme square wave. Plan: docs/../../live2d/CUBISM_PHYSICS_PORT.md §"Pinned baselines".
