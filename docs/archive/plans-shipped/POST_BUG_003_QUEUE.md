...
4. ~~**Body chain residual ~5 px PARAM** on `BodyAngleX/Z`, `Breath`~~ → **CLOSED 2026-05-03 (Phase 2b Setup port shipped)**
   ...
   - All 92 test suites green. Default kernel flipped from `v3-legacy` to `cubism-setup`. Plan doc: [PHASE_2B_PLAN.md](PHASE_2B.md). Kernel-level write-up: [CUBISM_WARP_PORT.md](../../live2d/CUBISM_WARP_PORT.md).
...
8. **Cubism Warp Port Phase 4** (`docs/../../live2d/CUBISM_WARP_PORT.md`)
...
**🔥 Top priority — Cubism Physics Port** ([`../../live2d/CUBISM_PHYSICS_PORT.md`](../../live2d/CUBISM_PHYSICS_PORT.md))
