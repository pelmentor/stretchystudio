...
**Status:** ✅ SHIPPED 2026-05-02. See [../../WORKSPACES.md](../../WORKSPACES.md) for the post-rework contract.
...
9. **Docs** — rewrite [../../WORKSPACES.md](../../WORKSPACES.md) around the 3-workspace + mode-pill model. Update [FEATURE_GAPS.md](../../FEATURE_GAPS.md) and [BUGS.md](../../BUGS.md) for stale workspace references. Update memory entries.
...
- [CLICK_TO_SELECT.md](CLICK_TO_SELECT.md) — SHIPPED (triangle hit-test against rig frames).
- [TOOLBAR.md](TOOLBAR.md) — SHIPPED (Blender T-panel canvas toolbar).
