...
- Update `V3_RERIG_FLOW.md` if any notes need amending.
...
- ✅ **`BFA_006_DEFORMER_NODES.md` status update** — done iteratively across the seven phase commits; this final pass writes the close-out header.
...
- Re-rig flow that this plan needs to keep working: [V3_RERIG_FLOW.md](V3_RERIG_FLOW.md).
