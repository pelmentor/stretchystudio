...
> - [CUBISM_WARP_PORT.md](../../live2d/CUBISM_WARP_PORT.md) — kernel-port progress (Phase 0/1/2a/3 shipped; 2b blocked on rotation-matrix-structure refactor)
> - [BUGS.md](../../BUGS.md) — current open / fixed bugs
> - [WORKSPACES.md](../../WORKSPACES.md) — workspace + editMode + toolbar contract
...
Cross-ref: see [`RUNTIME_PARITY_PLAN.md`](RUNTIME_PARITY.md) — that
...
Status quo problems (see [AUTO_RIG_PLAN.md](AUTO_RIG.md) for
...
in `runInit`),
`docs/NATIVE_RIG_REFACTOR.md` (R8 row +
...
`docs/NATIVE_RIG_REFACTOR.md` (R7 row + this
...
`docs/NATIVE_RIG_REFACTOR.md` (R9 row + this
shipped subsection). **Tag:**
...
[RUNTIME_PARITY_PLAN.md](RUNTIME_PARITY.md)) and the evaluator
