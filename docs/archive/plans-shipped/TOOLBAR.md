...
7. Docs: update [../../WORKSPACES.md](../../WORKSPACES.md) with the toolbar overlay.
...
- No conditional gating by workspace (workspaces are layout-only — see [../../WORKSPACES.md](../../WORKSPACES.md)).
