...
[`docs/live2d-export/head-angle-x-technique/`](../../live2d/head-angle-x-technique/)
...
- [head-angle-x-technique/TECHNIQUE.md](../../live2d/head-angle-x-technique/TECHNIQUE.md)
  — full reverse-engineering + numeric defaults.
- [head-angle-x-technique/notes_01_skeleton.md](../../live2d/head-angle-x-technique/notes_01_skeleton.md)
  — phase map of the tutorial frames.
- [SESSION_23_FINDINGS.md](SESSION_23.md)) — previous session's
...
- `docs/SESSION_24.md` — this file.
- `docs/../plans-shipped/AUTO_RIG.md` — Session 24 evidence entry.
