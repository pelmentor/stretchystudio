...
- Phase 0 (oracle harness): see [CUBISM_PHYSICS_PORT_PHASE0_FINDINGS.md](../archive/plans-shipped/CUBISM_PHYSICS_PORT_PHASE0_FINDINGS.md). Verdict: port required. Max divergence 2.0; mean 0.5–1.3 across shelby+Hiyori.
...
- [`physicsConfig`](../../src/io/live2d/rig/physicsConfig.js) — rule shape + `resolvePhysicsRules`
