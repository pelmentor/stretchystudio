...
// `pruneOrphanedVariantParabolas` lives in `./eyeClosurePrune.js`
// (its canonical home) so `projectStore.js`'s synchronous deleteNode
// hook can import it at the top level without dragging this module's
// resolve/seed surface into the eager bundle. Slice-3 audit-fix
// HIGH-1, 2026-05-23. Import directly from `eyeClosurePrune.js` —
// no re-export here (no RULE-№2 compat-shim layer).
