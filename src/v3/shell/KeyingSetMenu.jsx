 ...
 *
 * Active set indicator -- if `project.activeKeyingSetId` matches the
 * row's id, render a "•" prefix. Slice 7.C does not set
 * `activeKeyingSetId` from this menu (deferred to 7.E's Shift+K
 * binding); the indicator is for 7.D auto-key configuration where the
 * active KS DOES get set explicitly.
 *
...
import { execApplyKeyingSet } from '../operators/insertKey.js';
